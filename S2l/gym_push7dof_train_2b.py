...
class Frame_Feature:
    def __init__(self):
         ...
         with self.g.as_default():
              ...
              self.base_model=keras.applications.vgg16.VGG16(include_top=False, weights='imagenet', input_tensor=None, input_shape=(height,width,channel), pooling=None, classes=1000)
              print('VggNet loaded with Imagenet values')
    
    def frame_feature_extractor(self,frame):
        frame= im_preprocess(frame_)
