...
class Saved_Policy:
    ...
    def __init__(self,num_states,num_actions):
        self.policy_savedpath="/home/ironman2/S2l_storage/policies_saved/Exp2_0deg/"
        self.network_graph_name='policy.episode-500.meta'
        self.network_name='policy.episode-500'
        ### policy_net
        self.g=tf.Graph()
