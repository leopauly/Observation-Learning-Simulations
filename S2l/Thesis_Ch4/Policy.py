...
class Saved_Policy:
    ...
    def __init__(self,num_states,num_actions):
        ...
        self.policy_savedpath="/home/ironman2/S2l_storage/policies_saved/Thesis_Ch4/"     
        self.network_graph_name='Task1.episode-18.meta'
        self.network_name='Task1.episode-18'
        ### policy_net
        self.g=tf.Graph()
